...
public class OwnerDocsUploadAdapterCompleted extends RecyclerView.Adapter<OwnerDocsUploadAdapterCompleted.DataViewHolder> implements Filterable {
    ...
    public OwnerDocsUploadAdapterCompleted(OwnerListDocsUploadInterface ownerListInterface) {
