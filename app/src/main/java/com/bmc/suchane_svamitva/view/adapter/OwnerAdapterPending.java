...
public class OwnerAdapterPending extends RecyclerView.Adapter<OwnerAdapterPending.DataViewHolder> implements Filterable {
    ...
    public OwnerAdapterPending(OwnerListInterface ownerListInterface) {
    ...
    @NonNull
    @Override
    public OwnerAdapterPending.DataViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.owner_list,
                new FrameLayout(parent.getContext()), false);
        return new OwnerAdapterPending.DataViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(OwnerAdapterPending.DataViewHolder holder, int position) {
    ...
    @Override
    public void onViewAttachedToWindow(@NonNull OwnerAdapterPending.DataViewHolder holder) {
        super.onViewAttachedToWindow(holder);
        holder.bind();
    }

    @Override
    public void onViewDetachedFromWindow(@NonNull OwnerAdapterPending.DataViewHolder holder) {
    ...
    public Filter getFilter() {
        if (valueFilter == null) {
            valueFilter = new OwnerAdapterPending.ValueFilter();
        }
        return valueFilter;
    }
